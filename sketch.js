        ...
        functions: {
            initialize: function () {
                ...
                this.textResistance.text =
                    "Résistance : " + player.stats.bateau.resistance_degats;
                ...
                this.textResistanceFeu.text =
                    "Résistance Feu : " + player.stats.bateau.resistance_feu;
                ...
                this.textDegatsBase.text =
                    "Dégâts Base : " + player.stats.arme.degats_base;
                ...
                this.textDegatsFeu.text =
                    "Dégâts Feu : " + player.stats.arme.degats_feu;
            ...
            run() {
                ...
                if (back.buttonMoreVie.mouse.pressed()) {
                    ...
                    back.textVie.text =
                        "Vie Max : " + player.stats.bateau.vieMax;
                ...
                if (back.buttonMoreResistance.mouse.pressed()) {
                    player.stats.bateau.resistance_degats += 0.1;
                    player.stats.bateau.resistance_degats = parseFloat(
                        player.stats.bateau.resistance_degats.toFixed(2)
                    );
                ...
                if (back.buttonMoreResistanceFeu.mouse.pressed()) {
                    player.stats.bateau.resistance_feu += 0.1;
                    player.stats.bateau.resistance_feu = parseFloat(
                        player.stats.bateau.resistance_feu.toFixed(2)
                    );
                    back.textResistanceFeu.text =
                        "Résistance Feu : " +
                        player.stats.bateau.resistance_feu;
                ...
                if (back.buttonMoreDegatsBase.mouse.pressed()) {
                    player.stats.arme.degats_base += 1;
                ...
                if (back.buttonMoreDegatsFeu.mouse.pressed()) {
                    player.stats.arme.degats_feu += 1;
